...
import com.PIproject.entities.Commande;
import com.PIproject.entities.SousPharmacie;
import com.PIproject.utils.DataSource;
import com.PIproject.services.service_commande;
    ...
    public void table() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String sql1 = "SELECT * FROM user where id=? And Role='SousPharmacie'";
                pst1 = conn.prepareStatement(sql1);
                pst1.setInt(1, id_pharmacie);
                ResultSet rs1 = pst1.executeQuery();
                while (rs1.next()) {
                    SousPharmacie pharmacie = new SousPharmacie();
...
private void ajouter_commande(ActionEvent event) {
    ...
    try {
        ...
        ResultSet rs = pst.executeQuery();
        while (rs.next()) {
            SousPharmacie p = new SousPharmacie(rs.getInt("id"));
    ...
    public void ajouter(Commande c) {
        try {
            ...
            pst.setInt(3, c.getPharmacie().getIdUser());
    ...
    public void selectPharma() {
        ...
        String reqUser = "SELECT * FROM user where Role='SousPharmacie'";
        try {
