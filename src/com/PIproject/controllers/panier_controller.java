...
import com.PIproject.entities.TableData;
import com.PIproject.entities.ligne_commande;
import com.PIproject.services.service_panier;
...
public class panier_controller {
    ...
    public void initialize() {
        ...
        List<Medicament> allMedications = new ArrayList<>();
        ...
        for (Medicament medication : allMedications) {
            medicationNames.add(medication.getNom_medi());
        }
        ...
        for (Map.Entry<Integer, Integer> entry : panier.getMeds().entrySet()) {
            ...
            Medicament med = new Medicament(); // Replace with the actual method
            if (med == null) {
            ...
            TableData row = new TableData(med.getNom_medi(), qte, 12.3,  12.3);
